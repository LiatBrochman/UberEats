...
import {useElapsedTimeContext} from "../../contexts/ElapsedTimeContext";
...
const Map = () => {
    ...
    const {elapsedTime: duration, isConnected} = useElapsedTimeContext()
    ...
    return (
        <>
            ...
            {isConnected && duration && <View style={styles.container}>
